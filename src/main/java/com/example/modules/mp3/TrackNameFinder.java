...
@Component
public class TrackNameFinder implements ModuleContract
{
    @Override
    ...
    {
        return "Prints track name from tags";
    }
    ...
    public void Execute(String filePath)
    {
        ...
        try {
            ...
            System.out.println("Track with name -  " + track.getTag().getFirst(FieldKey.TITLE));
        } catch (Exception e) {
